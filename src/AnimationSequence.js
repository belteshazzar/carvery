/**
 * AnimationSequence - A collection of animations and emitters that can be triggered together
 */
...
export class AnimationSequence {
  ...
  static fromJSON(name, json) {
    ...
    if (json.animations) {
      sequence.animationNames = [...json.animations];
    }
    if (json.emitters) {
      sequence.emitterNames = [...json.emitters];
    }
    return sequence;
  }
}
